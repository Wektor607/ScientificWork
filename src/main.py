...
import os
from supportFunctions.paintGraphics import paintGraphics
    ...
    while(n == '20' or n == '50' or n == '100'):
        ...
        while(1):
            while(i < len(lst)):
                ...
                z = input()
                if(z == ''):
                    print('Вы хотите использовать другой алгоритм для оптимизации этой задачи (yes/no):')
                    z = input()
                while(1):
                    if(z == 'no'):
                        break
                    elif(z == 'yes'):
                        print('Какой из методов вы хотите использовать для оптимизация маршрута для CVRPTW: SA / LKH / OptAlg / Gurobi?')
                        method = input()
                        ...
                        z = input()
                if(z == 'no'):
                    print(f'Вы хотите закончить работу программы для {n} точек(YES/NO):')
                    z = input()
                    while(1):
                        if(z == 'YES'):
                            break
                        elif(z == 'NO'):
                            print('Какой из методов вы хотите использовать для решения новой задачи оптимизации маршрута для CVRPTW: SA / LKH / OptAlg / Gurobi?')
                            method = input()
                            while(method not in meth_alg):
                                print('Попробуйте ещё раз!')
                                print('Какой из методов вы хотите использовать для решения новой задачи оптимизации маршрута для CVRPTW: SA / LKH / OptAlg / Gurobi?')    
        ...
        paintGraphics(lst_results, lst_legend, count_towns)

        print("Использовать алгоритмы для другого количества точек?(YES/NO):")
        another_count = input()
        while(another_count != 'YES' and another_count != 'NO'):
            print("Использовать алгоритмы для другого количества точек?(YES/NO):")
            another_count = input()
        
        if(another_count == "YES"):
            print("Введите количество городов(20, 50, 100): ")
            n = input()
            while(n != '20' and n != '50' and n != '100'):
                print("Введите количество городов(20, 50, 100): ")
